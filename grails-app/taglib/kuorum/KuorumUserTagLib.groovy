...
//            tooltip = message(code:'politician.image.icon.candidate.text');
    ...
    def followButton={attrs, body ->
        ...
        if (alias == WebConstants.FAKE_LANDING_ALIAS_USER && springSecurityService.isLoggedIn() && springSecurityService.principal.alias != WebConstants.FAKE_LANDING_ALIAS_USER && isFollowing){
//            cssClass = en
            out << """
    ...
    def ifUserIsTheLoggedOne={attrs, body->
        ...
        Boolean and = attrs.and == null ? true : attrs.and
        List<String> userIds = []
