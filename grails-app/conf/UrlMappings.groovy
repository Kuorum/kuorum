...
class UrlMappings {
	...
	static mappings = {
        ...
        name en_landingServices:    "/en/leaders-in-engagement"     (controller: "landing", action: "landingGovernments"){lang = "en"; mappingName="landingServices"}
        name es_landingServices:    "/es/lideres-en-participacion"  (controller: "landing", action: "landingGovernments"){lang = "es"; mappingName="landingServices"}
