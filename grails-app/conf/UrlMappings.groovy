...
//        name postAddDefender:"/ajax/proyectos/$regionName/$commission/$hashtag/propuesta/$postBrief-$postId/apadrinar"(controller: "post", action:"addDefender")
        ...
        name footerTechnology:    "/services"          (controller:"footer", action: "tech" )
                                  "/services/what-is-kuorum"          (controller:"footer", action: "tech" )
                                  "/kuorum/what-is-kuorum"          (controller:"footer", action: "tech" )
        name footerPoliticians:   "/services/politicians"               (controller:"footer", action: "politicians" )
                                  "/kuorum/politicians"               (controller:"footer", action: "politicians" )
        ...
        name footerCitizens:      "/services/citizens"              (controller:"footer", action: "citizens" )
                                  "/kuorum/citizens"              (controller:"footer", action: "citizens" )
        ...
        name footerDevelopers:    "/services/editors"         (controller:"footer", action: "developers" )
                                  "/kuorum/editors"         (controller:"footer", action: "developers" )
        name footerAboutUs:       "/about"                          (controller:"footer", action: "aboutUs" )
                                  "/about/our-story"                (controller:"footer", action: "aboutUs" )
                                  "/kuorum"                         (controller:"footer", action: "aboutUs" )
        name footerVision:        "/about/mision-and-vision"        (controller:"footer", action: "vision" )
                                  "/kuorum/mision-and-vision"        (controller:"footer", action: "vision" )
                                  "/kuorum/vision-y-valores"        (controller:"footer", action: "vision" )
        name footerImpact:        "/about/impact"      (controller:"footer", action: "impact" )
                                  "/kuorum/impact-measurement"      (controller:"footer", action: "impact" )
        name footerTeam:          "/about/our-team"          (controller:"footer", action: "team" )
                                  "/kuorum/our-team"          (controller:"footer", action: "team" )
                                  "/kuorum/nuestro-equipo"          (controller:"footer", action: "team" )
        name footerInformation:   "/press/information-and-resources"  (controller:"footer", action: "information" )
                                  "/kuorum/press"  (controller:"footer", action: "information" )
        ...
        name footerWidget:        "/press/widget"  (controller:"footer", action: "widget" )
                                  "/kuorum/widget"  (controller:"footer", action: "widget" )
        name footerPrivacyPolicy: "/legal"     (controller:"footer", action: "privacyPolicy")
                                  "/legal/privacy-policy"     (controller:"footer", action: "privacyPolicy")
                                  "/kuorum/privacy-policy"     (controller:"footer", action: "privacyPolicy")
        ...
        name footerTermsUse:      "/legal/terms-of-use"      (controller:"footer", action: "termsUse")
                                  "/kuorum/terms-of-use"      (controller:"footer", action: "termsUse")
