...
//        name postAddDefender:"/ajax/proyectos/$regionName/$commission/$hashtag/propuesta/$postBrief-$postId/apadrinar"(controller: "post", action:"addDefender")
        ...
        name profilePoliticianKnownFor: "/configuracion-politico/known-for"  (controller: "politicianProfile"){action=[GET:"editKnownFor", POST:"updateKnownFor"]}
        ...
        name footerInformation:   "/kuorum/informacion-y-recursos"  (controller:"footer", action: "information" )
