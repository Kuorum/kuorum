...
//                    model.put("_isSurveyPlatform", domainService.isSurveyPlatform())
                    model.put("_isSocialNetwork", CustomDomainResolver.domainRSDTO.getIsSocialNetwork())
                    model.put("_isUserProfileExtended", CustomDomainResolver.domainRSDTO.getIsUserProfileExtended())
