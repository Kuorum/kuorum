<div class="section-header">
    <h1><g:message code="${msgPrefix}.howItWorks.title"/></h1>
    <h3 class="hidden-xs"><g:message code="${msgPrefix}.howItWorks.subtitle"/></h3>
</div>
<div class="row section-body">
    <ul class="globus">
        <li class="col-sm-4 col-md-4">
            <img class="img-responsive" src="${r.resource(dir:'images/landing', file:'howitworks-02-small.png')}" alt="step 1">
            ...
            <ul class="onecol bullets col-12">
                <li class="col-6 col-md-offset-3 col-sm-offset-3 col-xs-offset-4">
                    <img src="${r.resource(dir:'images/landing', file:'arrow.png')}"/>
        ...
        <li class="col-sm-4 col-md-4">
            <img class="img-responsive" src="${r.resource(dir:'images/landing', file:'howitworks-02-small.png')}" alt="step 2">
        ...
        <li class="col-sm-4 col-md-4">
            <img class="img-responsive" src="${r.resource(dir:'images/landing', file:'howitworks-02-small.png')}" alt="step 3">
