...
<div itemprop="provider" itemscope itemtype="http://schema.org/Service">
    <meta itemprop="serviceType" content="Communication" />
        ...
        <div class="popover">
            ...
            <div class="rating-info">
                ...
                <div class="rate-number">
                    ...
                    <span itemprop="ratingCount">${userReputation.numberEvaluations?:'0c'}</span>
                </div>
            </div>
