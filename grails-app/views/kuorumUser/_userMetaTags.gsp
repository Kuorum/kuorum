...
<meta name="description" content="${g.message(code:'page.politicianProfile.description', args:[user.fullName])}" />
...
<meta itemprop="description" content="${g.message(code:'page.politicianProfile.description', args:[user.fullName])}">
...
<meta name="twitter:title" content="${g.message(code:'page.politicianProfile.title', args:[user.fullName])}">
%{--Page description less than 200 characters--}%
<meta name="twitter:description" content="${g.message(code:'page.politicianProfile.description', args:[user.fullName])}">
...
<!-- Open Graph data -->
<meta property="og:title" content="${g.message(code:'page.politicianProfile.title', args:[user.fullName])}" />
...
<meta name="title" content="${g.message(code:'page.politicianProfile.title', args:[user.fullName])}" />
<meta name="description" content="${g.message(code:'page.politicianProfile.description', args:[user.fullName])}" />
<meta property="og:description" content="${g.message(code:'page.politicianProfile.description', args:[user.fullName])}" />
