...
<head>
    ...
    <r:require modules="post, districtProposal, kuorumUser, contestApplication"/>
</head>
...
<content tag="mainContent">
    <div class="panel panel-default">
        <div class='profile-header'>
            ...
            <image:userImgProfile user="${politician}"
                                  alt="${g.message(code: 'page.politicianProfile.imageProfile.alt', args: [politician.fullName])}"/>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row extra-padding">
                <div class='col-sm-7 profile-title'>
                    ...
                    <p class='party' itemprop="affiliation"><span itemscope
            ...
            <div class="extra-padding" id="politician-bio">
                <g:render template="/kuorumUser/userShowTemplates/userNews"
                          model="[user: politician, userNews: userNews]"/>
