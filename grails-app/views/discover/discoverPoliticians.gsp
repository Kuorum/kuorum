...
<head>
    <title><g:message code="page.title.discover.politicians"/> </title>
...
<content tag="leftMenu">
    ...
    <g:render template="discoverLeftMenu" model="[activeMapping:'discoverPoliticians', dynamicDiscoverLaws:dynamicDiscoverLaws]"/>
