...
<head>
    <title><g:message code="page.title.discover.publications"/> </title>
...
<content tag="leftMenu">
    ...
    <g:render template="discoverLeftMenu" model="[activeMapping:'discoverRecentPosts', dynamicDiscoverLaws:dynamicDiscoverLaws]"/>
...
<content tag="mainContent">
    <div class="clearfix">
        <h1>
            <g:message code="discover.title.discover.recentPosts"/>
        </h1>
    </div>
