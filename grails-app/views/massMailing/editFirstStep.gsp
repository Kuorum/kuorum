...
<content tag="mainContent">
    ...
    <g:render template="types/editFirstStepContent" model="[command: command, filters: filters, totalContacts: totalContacts, campaignId: campaignId, anonymousFilter: anonymousFilter]"/>
