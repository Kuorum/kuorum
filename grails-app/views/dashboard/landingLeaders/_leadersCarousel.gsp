<!-- ^fade-carousel !-->
<div id="carousel-new-landing" class="carousel slide fade-carousel" data-ride="carousel" data-interval="5000" data-pause="null">
    <!-- Indicators -->
    <div class="container indicators">
        <ol class="carousel-indicators">
            ...
            <li class="text"><g:message code="landingLeaders.carousel.slide1.text"/> </li>
        </ol>
    </div>
    <!-- Wrapper for slides -->
    <div class="content container">
        <hgroup>
            <h1><g:message code="landingLeaders.carousel.slogan"/> </h1>
            <h3 class="hidden-xs"><g:message code="landingLeaders.carousel.subslogan"/></h3>
        </hgroup>
        <a href="#how-it-works" class="btn btn-lg btn-blue-light" data-effect="scroll"><g:message code="landingLeaders.carousel.howItWorks"/> </a>
        </br class="hidden-xs">
        ...
        <g:form mapping="register" autocomplete="off" method="post" name="landing-register" class="form-inline dark hidden-xs" role="form" novalidate="novalidate">
            <fieldset>
                ...
                <button type="submit" class="btn btn-blue btn-lg col-lg-4"><g:message code="landingLeaders.carousel.login.submit"/></button>
            </fieldset>
        </g:form>
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item slides active">
            <div class="slide-1 leaders">
                <div class="overlay"></div>
            </div>
        </div> <!-- slide 1 leaders !-->

        <div class="item slides">
            <div class="slide-2 leaders">
                <div class="overlay"></div>
            </div>
        </div> <!-- slide 2 leaders !-->

        <div class="item slides">
            <div class="slide-3 leaders">
                <div class="overlay"></div>
            </div>
        </div> <!-- slide 3 leaders !-->
    </div>
...
<script>
    $(function(){
        ...
        $('#carousel-new-landing').on('slid.bs.carousel', function (event) {
            ...
            var messages = {
                'slide-0': '<g:message code="landingLeaders.carousel.slide1.text"/>',
                'slide-1': '<g:message code="landingLeaders.carousel.slide2.text"/>',
                'slide-2': '<g:message code="landingLeaders.carousel.slide3.text"/>',
                'slide-3': 'texto 4',
                'slide-4': 'texto 5',
                'slide-5': 'texto 6',
                'slide-6': 'texto 7',
