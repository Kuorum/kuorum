<div class="col-md-6">
    <h1><g:message code="${msgPrefix}.featuresCustom.title"/> </h1>
    <ul class="checklist">
        <li class="clearfix">
            <div class="col-md-1 col-xs-1"><i class="fa fa-check" aria-hidden="true"></i></div>
            <div class="col-md-11 col-xs-11"><span><g:message code="${msgPrefix}.featuresCustom.bullet1.bold"/></span> - <g:message code="${msgPrefix}.featuresCustom.bullet1.description"/></div>
        </li>
        <li class="clearfix">
            <div class="col-md-1 col-xs-1"><i class="fa fa-check" aria-hidden="true"></i></div>
            <div class="col-md-11 col-xs-11"><span><g:message code="${msgPrefix}.featuresCustom.bullet2.bold"/></span> - <g:message code="${msgPrefix}.featuresCustom.bullet2.description"/></div>
        </li>
        <li class="clearfix">
            <div class="col-md-1 col-xs-1"><i class="fa fa-check" aria-hidden="true"></i></div>
