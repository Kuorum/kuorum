<section role="complementary" class="homeSub" id="saveTime-tag" data-smoothOffset="-105">
    <h3><g:message code="landingPage.organizations.features.title"/> </h3>
    ...
    <div class="row">
        <ul class="saveTime">
            ...
            <li class="col-sm-5 col-md-3">
                ...
                <h2><g:message code="landingPage.organizations.features.massMailing.title"/></h2>
                <p><g:message code="landingPage.organizations.features.massMailing.description"/></p>
                <g:link mapping="register">
            ...
            <li class="col-sm-5 col-sm-offset-2 col-md-3 col-md-offset-0">
                ...
                <h2><g:message code="landingPage.organizations.features.teamManagement.title"/></h2>
                <p><g:message code="landingPage.organizations.features.teamManagement.description"/></p>
                <g:link mapping="register">
