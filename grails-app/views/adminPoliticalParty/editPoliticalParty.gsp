...
<content tag="leftMenu">
    <h1>
        <g:message code="admin.editPoliticalParty.title"/>,
    </h1>
    %{--<p><g:message code="profile.changeEmail.description"/></p>--}%
    <g:render template="/admin/adminMenu" model="[activeMapping:'adminEditPoliticalParty', menu:menu]"/>

</content>

<content tag="mainContent">
    <h1><g:message code="admin.editPoliticalParty.title"/></h1>
    <formUtil:validateForm bean="${command}" form="createLaw"/>
    <g:form method="POST" mapping="adminEditPoliticalParty" name="createPoliticalParty" role="form">
        <g:hiddenField name="id" value="${command.id}" required="true"/>
