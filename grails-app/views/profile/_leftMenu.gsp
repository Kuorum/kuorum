...
<ul>
    ...
    <sec:ifAnyGranted roles="ROLE_POLITICIAN">
        ...
        <li class="${activeMapping=='profilePoliticianKnownFor'?'active':''}">
            <g:link mapping="profilePoliticianKnownFor"><g:message code="profile.menu.profilePoliticianKnownFor"/></g:link>
        </li>
    </sec:ifAnyGranted>
