...
<table id="participatoryBudgetProposalReviewTable"
    ...
    <tr>
        ...
        <th data-field="district.name" data-halign="center" data-align="center" data-sortable="true" data-visible="true"
            data-filter-control="select" data-filter-data="var:filterDataDistrict"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.districtName"/></th>
        <th data-field="district.budget" data-halign="center" data-align="center" data-sortable="false"
            data-visible="false"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.districtBudget.${participatoryBudget.participatoryBudgetType}"/></th>
        <th data-field="cause" data-halign="center" data-align="center" data-sortable="false" data-visible="false"
        ...
        <th data-field="approved" data-halign="center" data-align="center" data-sortable="false"
            data-visible="${visibleTechnicalReviewStatus}" data-filter-control="select"
            data-formatter="formatCheckValidation" data-events="inputEventsCheckValidation"
            data-filter-data="var:filterDataApproved"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.approved"/></th>
        <th data-field="price" data-halign="center" data-align="center" data-sortable="true"
            data-visible="${visibleTechnicalReviewStatus}" data-formatter="formatPrice"
            data-events="inputEventsPrice"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.price"/></th>
        <th data-field="rejectComment" data-halign="center" data-align="center" data-sortable="false"
            data-visible="${visibleTechnicalReviewStatus}" data-filter-control="input" data-formatter="formatRejectText"
            data-events="inputEventsRejectComment"
            data-filter-control-placeholder="${g.message(code: 'tools.massMailing.view.participatoryBudget.proposalList.table.rejectComment.searchPlaceholder')}"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.rejectComment"/></th>
        <th data-field="technicalReviewStatus.i18n" data-halign="center" data-align="center" data-sortable="false"
            data-visible="${visibleTechnicalReviewStatus}" data-filter-control="select"
            data-filter-data="var:filterDataTechnicalReview"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.technicalReviewStatus"/></th>
        <th data-field="implemented" data-halign="center" data-align="center" data-sortable="false"
            data-visible="${visibleImplemented}" data-filter-control="select" data-formatter="formatBoolean"
            data-filter-data="var:filterDataImplemented"><g:message
                code="tools.massMailing.view.participatoryBudget.proposalList.table.implemented"/></th>
    </tr>
    </thead>
</table>
