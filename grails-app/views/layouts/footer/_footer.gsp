                ...
                <div class="col-xs-12 col-sm-8 col-md-8">
                    <g:if test="${_social}">
                        <ul class="social">
                            ...
                            <g:if test="${_social?.googlePlus}"><li><a href="${_social.googlePlus}" target="_blank"><span class="sr-only" target="_blank">Google+</span><span class="fa-stack fa-lg"><span class="fas fa-circle fa-stack-2x"></span><span class="fab fa-google-plus-g fa-stack-1x"></span></span></a></li></g:if>
