...
<div class="modal fade modal-domain-validation" id="domain-validation" tabindex="-1" role="dialog"
     aria-labelledby="modal-domain-validation-title" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-domain-validation modal-domain-validation-tokenMail">
                    <g:render template="/layouts/modals/modalDomainValidation_TokenMailForm"/>
                </div>
