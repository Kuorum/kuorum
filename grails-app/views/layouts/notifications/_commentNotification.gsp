<g:set var="text">
    <g:message code="notifications.commentNotification.text" args="[notification.text.substring(0, Math.min(notification.text.size(), 50))+'...']"/>
</g:set>
...
<g:render
        ...
        model="[
                ...
                user:notification.commentWriter,
                text:text,
