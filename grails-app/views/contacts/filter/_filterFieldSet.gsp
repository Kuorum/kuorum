...
<div id="${formId}" class="disabled-filters hide">
    ...
    <fieldset class="new-filter-actions">
        <g:link mapping="politicianContactsSearch" elementId="numberRecipients"><g:message code="tools.contact.filter.form.recipients" args="[filter.amountOfContacts?:'-']"/></g:link>
