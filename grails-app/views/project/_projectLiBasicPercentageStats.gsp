<li class="vote-yes">
    <span><g:formatNumber number="${projectBasicStats.percentagePositiveVotes}" type="percent"/> </span>
    <span class="sr-only"><g:message code="project.subHeader.positiveVotes"/></span>
    <span class="icon-smiley fa-lg"></span>
</li>
<li class="vote-no">
    <span><g:formatNumber number="${projectBasicStats.percentageNegativeVotes}" type="percent"/> </span>
...
<li class="vote-neutral">
    <span><g:formatNumber number="${projectBasicStats.percentageAbsVotes}" type="percent"/> </span>
    <span class="sr-only"><g:message code="project.subHeader.absVotes"/></span>
    <span class="icon-neutral fa-lg"></span>
</li>
<li>
    <span>${projectBasicStats.numPublicPosts}</span>
