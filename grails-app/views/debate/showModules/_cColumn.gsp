<ul class="leader-post-stats">
    ...
    <li>
        ...
        <span class="info"><g:message code="debate.lastActivity"/> <kuorumDate:humanDate date="${proposalPage?.data?.collect{[it.datePublished]+it.comments*.datePublished}.flatten().max()?:debate.datePublished}"/> </span>
    </li>
</ul>
