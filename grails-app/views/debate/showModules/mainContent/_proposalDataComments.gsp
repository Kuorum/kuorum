<div class="conversation-box-comments">
    ...
    <div class="comment-box">
        <div class="comment-proposal clearfix">
            ...
            <div class="comment editable-comment col-md-11 col-xs-12" data-placeholder="${message(code: "debate.proposal.placeholder")}" style="min-height: 100px; padding-top: 20px"></div>
        </div>
