...
<g:if test="${debate.campaignStatusRSDTO == org.kuorum.rest.model.notification.campaign.CampaignStatusRSDTO.SENT}">
    <g:render template="/debate/showModules/proposalSection" model="[debate: debate, debateUser: debateUser, proposalPage: proposalPage,eventRegistration:eventRegistration]" />
</g:if>
