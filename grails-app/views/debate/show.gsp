...
<content tag="mainContent">
    ...
    <g:render template="/campaigns/columnCModules/eventCallToAction" model="[debate: debate, eventUser:debateUser,event:debate.event,eventRegistration:eventRegistration]"/>
</content>
