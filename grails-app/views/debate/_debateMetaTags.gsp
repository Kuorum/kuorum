...
<meta itemprop="name" content="${g.message(code:'debate.show.title', args:[debate.title])}">
...
<meta name="twitter:title" content="${g.message(code:'debate.show.title', args:[debate.title])}">
...
<!-- Open Graph data -->
<meta property="og:title" content="${g.message(code:'debate.show.title', args:[debate.title])}" />
...
<meta name="title" content="${g.message(code:'debate.show.title', args:[debate.title])}" />
