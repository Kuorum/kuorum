...
<meta itemprop="name" content="${g.message(code:titleMessageCode, args:[debate.title])}">
...
<meta name="twitter:title" content="${g.message(code:titleMessageCode, args:[debate.title])}">
...
<!-- Open Graph data -->
<meta property="og:title" content="${g.message(code:titleMessageCode, args:[debate.title])}" />
...
<meta name="title" content="${g.message(code:titleMessageCode, args:[debate.title])}" />
