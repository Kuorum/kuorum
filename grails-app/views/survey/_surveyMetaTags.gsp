...
<meta itemprop="name" content="${g.message(code:titleMessageCode, args:[survey.title])}">
...
<meta name="twitter:title" content="${g.message(code:titleMessageCode, args:[survey.title])}">
...
<!-- Open Graph data -->
<meta property="og:title" content="${g.message(code:titleMessageCode, args:[survey.title])}" />
...
<meta name="title" content="${g.message(code:titleMessageCode, args:[survey.title])}" />
