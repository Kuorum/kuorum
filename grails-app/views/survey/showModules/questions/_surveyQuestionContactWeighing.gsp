<g:if test="${contact != null}">
    ...
    <g:if test="${questionTypeMultiples.contains(question.questionType)
        ...
        <div class="survey-question-extra-info-points"><g:message
                code="contact.weighing.question.oneOption" args="[contact.getSurveyVoteWeight()]"/></div>
    </g:if>
    <g:if test="${question.questionType == org.kuorum.rest.model.communication.survey.QuestionTypeRSDTO.TEXT_OPTION && contact.getSurveyVoteWeight() != 1}">
        <div class="survey-question-extra-info question-${question.id}">
            <div class="survey-question-extra-info-range">
                <div class="survey-question-extra-info-points"><g:message
    ...
    </g:if><g:if test="${question.questionType == org.kuorum.rest.model.communication.survey.QuestionTypeRSDTO.RATING_OPTION && contact.getSurveyVoteWeight() != 1}">
        <div class="survey-question-extra-info question-${question.id}">
            <div class="survey-question-extra-info-range">
                <div class="survey-question-extra-info-points"><g:message
                        code="contact.weighing.question.oneOption" args="[contact.getSurveyVoteWeight()]"/></div>
