...
<g:if test="${questionTypeMultiples.contains(question.questionType)}">
    <div class="survey-question-extra-info">
        ...
        <g:if test="${[org.kuorum.rest.model.communication.survey.QuestionTypeRSDTO.ONE_OPTION_WEIGHTED,
                       org.kuorum.rest.model.communication.survey.QuestionTypeRSDTO.MULTIPLE_OPTION_POINTS].contains(question.questionType)}">
        ...
        <g:if test="${[org.kuorum.rest.model.communication.survey.QuestionTypeRSDTO.MULTIPLE_OPTION_WEIGHTED].contains(question.questionType)}">
            <div class="survey-question-extra-info-points"><g:message code="survey.questions.header.extrainfo.multi.points.weigth" args="[(question.maxAnswers?:question?.options?.size()?:0)*question.points, question.minAnswers*question.points, 1, question.points ]"/> </div>
        </g:if>
    </div>
</g:if>