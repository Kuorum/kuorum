...
<g:if test="${org.kuorum.rest.model.notification.campaign.CampaignStatusRSDTO.SCHEDULED.equals(districtProposal.newsletter?.status?:null)}">
    <g:set var="callTitleMsg" value="${g.message(code:"districtProposal.callToAction.SCHEDULED.title", args: [campaignUser.name])}"/>
    <g:set var="callSubtitleMsg" value="${g.message(code:"districtProposal.callToAction.SCHEDULED.subtitle", args: [campaignUser.name])}"/>
</g:if>
<g:elseif test="${org.kuorum.rest.model.notification.campaign.CampaignStatusRSDTO.PROCESSING.equals(districtProposal.newsletter?.status?:null)}">
    <g:set var="callTitleMsg" value="${g.message(code:"districtProposal.callToAction.PROCESSING.title", args: [campaignUser.name])}"/>
    <g:set var="callSubtitleMsg" value="${g.message(code:"districtProposal.callToAction.PROCESSING.subtitle", args: [campaignUser.name])}"/>
</g:elseif>
