    ...
    <g:if test="${showBudgetProgressBar}">
        <div class="budget">
            <div class="campaign-progress-bar-wrapper">
                <h4>
                    <g:set var="budgetHTMLTitle"><span class="budget-price"><g:formatNumber
                            number="${districtProposal.district.budget}" type="number"
                            maxFractionDigits="0"/></span></g:set>
                    <g:message
                            code="districtProposal.callToAction.district.${districtProposal.participatoryBudget.participatoryBudgetType}.info.progressBar"
                            args="[budgetHTMLTitle]" encodeAs="raw"/>:
                </h4>

                <div class="campaign-progress-bar"
                     data-width="${Math.round(districtProposal.district.amountUserInvested / districtProposal.district.budget * 100)}">
                    <div class="pop-up">
                        <g:set var="amountHTML"><span class="amount-user-invested"><g:formatNumber
                                number="${districtProposal.district.amountUserInvested}" type="number"
                                maxFractionDigits="0"/></span></g:set>
                        <g:set var="budgetHTML"><g:formatNumber number="${districtProposal.district.budget}"
                                                                type="number" maxFractionDigits="0"/></g:set>
                        <g:message
                                code="districtProposal.callToAction.district.${districtProposal.participatoryBudget.participatoryBudgetType}.info.progressBar.tooltip"
                                args="[amountHTML, budgetHTML]" encodeAs="raw"/>
                        <div class="arrow"></div>
                    </div>
