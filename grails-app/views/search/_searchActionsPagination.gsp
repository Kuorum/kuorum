<div class="clearfix search-actions">
    <div class="col-md-6 search-text">
        <g:if test="${searchParams.word}">
            <h5 id="results"><g:message code="search.head.title.filterType.${searchParams.type}" args="[searchParams.word?.encodeAsHTML()]"/> <g:message code="search.head.title.numResults" args="[docs.total]"/> </h5>
        </g:if>
        <g:else>
