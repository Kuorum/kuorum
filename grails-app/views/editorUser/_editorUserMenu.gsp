...
<ul>
    ...
    <sec:ifAnyGranted roles="ROLE_EDITOR">
        <g:if test="${user.userType == kuorum.core.model.UserType.POLITICIAN}">
            ...
            <li class="${nav.activeMenuCss(mappingName: 'editorEditNews', urlParams:user.encodeAsLinkProperties())}">       <g:link mapping="editorEditPoliticianRelevantEvents" params="${user.encodeAsLinkProperties()}"><g:message code="admin.menu.user.editNews" args="[user.name]"/> </g:link></li>
