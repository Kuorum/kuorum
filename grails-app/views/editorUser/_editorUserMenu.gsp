...
<ul>
    ...
    <sec:ifAnyGranted roles="ROLE_EDITOR">
        <g:if test="${user.userType == kuorum.core.model.UserType.POLITICIAN}">
            ...
            <li class="${nav.activeMenuCss(mappingName: 'editorEditPoliticianRelevantEvents', urlParams:user.encodeAsLinkProperties())}">       <g:link mapping="editorEditPoliticianRelevantEvents" params="${user.encodeAsLinkProperties()}"><g:message code="admin.menu.user.editKnownFor" args="[user.name]"/> </g:link></li>
            ...
            <li class="${nav.activeMenuCss(mappingName: 'editorEditPoliticianExternalActivity', urlParams:user.encodeAsLinkProperties())}">     <g:link mapping="editorEditPoliticianExternalActivity" params="${user.encodeAsLinkProperties()}">  <g:message code="admin.menu.user.editLastActivity" args="[user.name]"/></g:link></li>
            <li class="${nav.activeMenuCss(mappingName: 'editorEditPoliticianExperience', urlParams:user.encodeAsLinkProperties())}">           <g:link mapping="editorEditPoliticianExperience" params="${user.encodeAsLinkProperties()}"> <g:message code="admin.menu.user.editPoliticianExperience" args="[user.name]"/></g:link></li>
        </g:if>
        <g:else>
            <li class="${nav.activeMenuCss(mappingName: 'editorKuorumAccountEdit', urlParams:user.encodeAsLinkProperties())}">                  <g:link mapping="editorKuorumAccountEdit" params="${user.encodeAsLinkProperties()}"><g:message code="admin.menu.user.editAccount" args="[user.name]"/></g:link></li>
            <li class="${nav.activeMenuCss(mappingName: 'editorEditUserProfile', urlParams:user.encodeAsLinkProperties())}">                    <g:link mapping="editorEditUserProfile" params="${user.encodeAsLinkProperties()}"> <g:message code="admin.menu.user.editProfile" args="[user.name]"/></g:link></li>
