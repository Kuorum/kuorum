<nav>
    <ul>
        ...
        <li>
            <g:link mapping="footerPrivacyPolicy" class="${activeMapping=='footerPrivacyPolicy'?'active':''}"><g:message code="layout.footer.privacyPolicy"/></g:link>
        </li>
        <li>
            <g:link mapping="footerTermsUse"  class="${activeMapping=='footerTermsUse'?'active':''}"><g:message code="layout.footer.termsUse"/></g:link>
        </li>
