...
<g:render template="/participatoryBudget/showModules/mainContent/districtProposals" model="[participatoryBudget: participatoryBudget, campaignUser: campaignUser]"/>
