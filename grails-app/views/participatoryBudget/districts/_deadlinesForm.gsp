...
<form action="#" class="form-horizontal campaign-form" id="districtParticipatoryBudgetForm" method="POST"
    ...
    <fieldset aria-live="polite" class="form-group">
        ...
        <div class="col-sm-offset-1 col-sm-4">
            <formUtil:date command="${command}" field="deadLineProposals" showLabel="true"/>
        </div>

        <div class="col-sm-4">
            <formUtil:date command="${command}" field="deadLineTechnicalReview" showLabel="true"/>
        </div>
        ...
        <div class="col-sm-4">
            <formUtil:date command="${command}" field="deadLineFinalReview" showLabel="true"/>
        </div>
    </fieldset>
