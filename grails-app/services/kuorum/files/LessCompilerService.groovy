...
class LessCompilerService implements ApplicationContextAware {
    ...
    private static final String PARAM_BTN_COLOR_HOVER="@btnColorHover";                 //="${domainConfigRSDTO.secondaryColor} !important";
    ...
    private static final String PARAM_CAMPAIGN_ICON_BORDER="@campaignIconBorderColor";  //="${domainConfigRSDTO.secondaryColor}";
