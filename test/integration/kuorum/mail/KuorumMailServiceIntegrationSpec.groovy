...
class KuorumMailServiceIntegrationSpec extends Specification{
    ...
    void "test send mail of defending post notification" () {
        ...
        kuorumMailService.sendPostDefendedNotificationMailInterestedUsers(post, peopleNotified)
        kuorumMailService.sendPostDefendedNotificationMailPoliticians(post, peopleAlerted)
