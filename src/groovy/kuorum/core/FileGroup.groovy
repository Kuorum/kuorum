...
public enum FileGroup {
    ...
    USER_PROFILE("UsersFiles", 1024 * 1000 *8/*1 MB */, '16/9', 110),
    PROJECT_IMAGE("ProjectsFiles", 1024 * 1000 *10 /*10 MB */, '16/9', 738),
    POST_IMAGE("PoliticianFiles", 1024 *1000 *8 /*8 MB */,'16/9',738),
