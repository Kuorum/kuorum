$(function ($)
{
    var i18n ={
        "en":{
            "placeholder":{"month":"month", "day":"day", "year":"year"},
            "number": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
            "short": ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
            "long": ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
        },
        "es":{
            "placeholder":{"month":"mes", "day":"día", "year":"año"},
            "number": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
            "short": ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"],
            "long": ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"]
        },
        "ca":{
            "placeholder":{"month":"mes", "day":"dia", "year":"any"},
            "number": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
        ...
        "de":{
            "placeholder":{"month":"Monat", "day":"Tag", "year":"Jahr"},
            "number": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
    ...
    generateBirthdayPicker = function ($parent, options) 
    {
        ...
        var language = i18n[options.language];
        ...
        // Create the html picker skeleton
         ...
         // Add the option placeholders if specified
          if (options.placeholder) {
            $("<option value='0'>"+language.placeholder.year+"</option>").appendTo($year);
            $("<option value='0'>"+language.placeholder.month+"</option>").appendTo($month);
            $("<option value='0'>"+language.placeholder.day+"</option>").appendTo($day);
          }
         ...
         for (var i = 0; i <= 11; i++) {
             $("<option></option>").attr('value', i + 1).text(language[options.monthFormat][i]).appendTo($month);
         }
         for (var i = 1; i <= 31; i++) {
