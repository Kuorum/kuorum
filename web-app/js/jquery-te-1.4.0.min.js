...
(function(e) {
    e.fn.jqte = function(t) {
        ...
        var o = ["Web Address", "E-mail Address"];
        var u = e.extend({
            status: true,
            css: "jqte",
            title: true,
        ...
        return this.each(function() {
            ...
            function z(t) {
                y.focus();
                R(t);
                if (w.data("linktype") == "0" && !y.val().startsWith("http") ){
                    // Preprocess link adding http if is missing
                    y.val("http://"+ y.val())
                }
                t.removeAttr(S);
            ...
            e(this).after('<div class="' + u.css + '" tabindex="14"></div>');
